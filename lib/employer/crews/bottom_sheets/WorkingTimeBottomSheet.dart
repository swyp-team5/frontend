...
class WorkingTimeBottomSheet extends StatefulWidget {
  const WorkingTimeBottomSheet({
    super.key,
  ...
  static Future<StoreTimeRange?> show(
    ...
    return showModalBottomSheet<StoreTimeRange>(
      ...
      builder: (_) => WorkingTimeBottomSheet(
        // initial 값 전달
  ...
  @override
  State<WorkingTimeBottomSheet> createState() =>
      _WorkingTimeBottomSheetState();
}

class _WorkingTimeBottomSheetState extends State<WorkingTimeBottomSheet> {
