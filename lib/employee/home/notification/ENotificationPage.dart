...
class ENotificationPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ENotificationPage> createState() =>
      _ENotificationPageState();
}

class _ENotificationPageState
    extends ConsumerState<ENotificationPage> {
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              GestureDetector(
                                onTap: () =>
                                    _showEmojiPicker(context, index,),
