...
class SubstituteRequest extends StatelessWidget {
  const SubstituteRequest({super.key});
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    _InfoRow(title: "대타 신청자", value: applicant),

                    const SizedBox(height: 30),

                    _InfoRow(title: "대타 신청 사유", value: reason),
