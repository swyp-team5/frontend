...
class EWeekSchedulePage extends StatefulWidget {
  ...
  @override
  State<EWeekSchedulePage> createState() => _EWeekSchedulePageState();
}

class _EWeekSchedulePageState extends State<EWeekSchedulePage> {
